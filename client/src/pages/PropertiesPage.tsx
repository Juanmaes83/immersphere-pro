                            ...
                            <div className="grid grid-cols-1 gap-3">
                              {space.assets.length === 0 ? (
                                ...
                                space.assets.map((asset) => (
                                  <div key={asset.id} className="flex flex-col gap-3 rounded-xl bg-white p-3 ring-1 ring-slate-200 min-w-0 md:flex-row md:items-start md:justify-between md:gap-4">
                                    <div className="flex min-w-0 flex-1 items-start gap-3">
                                      ...
                                      <div className="min-w-0 flex-1 overflow-hidden">
                                        ...
                                        <p className="truncate text-sm font-bold text-slate-700">{asset.url || 'Sin URL'}</p>
                                      </div>
                                    </div>
                                    ...
                                    <div className="flex flex-wrap items-center gap-2 md:ml-auto">
                                      ...
                                      <button type="button" onClick={() => void handleDeleteAsset(property.id, space.id, asset.id)} className="rounded-full px-3 py-2 text-sm font-black text-red-400 transition-colors hover:bg-red-50 hover:text-red-600">
                                        Eliminar
                                      </button>
                                    </div>
                                  </div>
